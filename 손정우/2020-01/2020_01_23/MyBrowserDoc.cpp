...
// MyBrowserDoc.cpp: CMyBrowserDoc 클래스의 구현
//
...
CMyBrowserDoc::CMyBrowserDoc() noexcept
{
...
// 축소판 그림을 지원합니다.
void CMyBrowserDoc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
...
// 검색 처리기를 지원합니다.
void CMyBrowserDoc::InitializeSearchContent()
{
...
void CMyBrowserDoc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
