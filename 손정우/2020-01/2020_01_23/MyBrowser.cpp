...
// MyBrowser.cpp: 애플리케이션에 대한 클래스 동작을 정의합니다.
//
...
BEGIN_MESSAGE_MAP(CMyBrowserApp, CWinApp)
	ON_COMMAND(ID_APP_ABOUT, &CMyBrowserApp::OnAppAbout)
...
CMyBrowserApp::CMyBrowserApp() noexcept
{
	// 다시 시작 관리자 지원
	...
	SetAppID(_T("MyBrowser.AppID.NoVersion"));

	// TODO: 여기에 생성 코드를 추가합니다.
	// InitInstance에 모든 중요한 초기화 작업을 배치합니다.
}

// 유일한 CMyBrowserApp 개체입니다.
...
int CMyBrowserApp::ExitInstance()
{
